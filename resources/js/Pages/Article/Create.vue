        ...
        <CardBox isForm @submit.prevent="saveForm">
            <Tabs v-model="activeTab" variant="underline" class="p-5">
                ...
                <Tab name="general" title="Datos generales" :disabled="false">
                    <FormField required label="Titulo de Proyecto:" :error="form.errors.title">
                        <FormControl height="h-12" v-model="form.title" placeholder="Titulo" />
                    </FormField>

                    <FormField required label="Modalidad Ddez:" :error="form.errors.state_id">
                        ...
                        <div class="flex items-center ps-4 border border-gray-400 rounded dark:border-gray-700 h-12">
                            <input id="bordered-radio-2" type="radio" value="Proyecto corto - Poster (2 hojas)"
                    ...
                    <FormField label="Cargar archivo PDF:" required help="Solo archivos PDF (MAX 100M)"
                        ...
                        <div
                            ...
                            <div v-if="form.file">
                                <div
                                    class="text-sm text-gray-700 dark:text-slate-300 font-medium max-md:text-xs text-center mb-5">
                                    <p>Nombre del archivo: {{ form.file?.name }}</p>
                                    <p>Tamaño: {{ form.file?.size / 1000 }} kilobytes</p>
                                </div>
                                <div class="justify-center flex">
                                    <iframe v-if="form.file.type === 'application/pdf'" :src="getFileURL"
                                        class="w-4/5 h-96 md:h-[400px]" />
